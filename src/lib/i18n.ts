...
const translations = {
  en: {
    ...
    sendToTm1: 'Search in TecDoc',
    sendToTm1Sent: 'Added to TM1',
    sendToTm1NotFound: 'No matching TecDoc vehicle found.',
    sendToTm1SearchFailed: 'TecDoc search failed. Please try again.',
    selectTecDocMatch: 'Select the matching vehicle',
    tecDocMatchPercent: 'Match',
    tecDocModelSeries: 'Model',
    tecDocType: 'Type',
    tecDocEngine: 'Engine',
    tecDocEngineCode: 'Engine Code',
    tecDocProductionYears: 'Constr.year',
    tecDocPower: 'Power',
    tecDocCapacity: 'Capacity',
    tecDocCylinders: 'Cylinders',
    tecDocFuelType: 'Fuel type',
    tecDocChooseMatch: 'Add',
  ...
  bg: {
    ...
    sendToTm1: 'Търсене в TecDoc',
    sendToTm1Sent: 'Добавено в TM1',
    sendToTm1NotFound: 'Не е намерено съвпадение в TecDoc.',
    sendToTm1SearchFailed: 'Търсенето в TecDoc неуспешно. Опитайте отново.',
    selectTecDocMatch: 'Изберете съответстващия автомобил',
    tecDocMatchPercent: 'Съвпадение',
    tecDocModelSeries: 'Модел',
    tecDocType: 'Тип',
    tecDocEngine: 'Двигател',
    tecDocEngineCode: 'Код на двигателя',
    tecDocProductionYears: 'Констр. година',
    tecDocPower: 'Мощност',
    tecDocCapacity: 'Обем',
    tecDocCylinders: 'Цилиндри',
    tecDocFuelType: 'Гориво',
    tecDocChooseMatch: 'Добави',
